...
class TestStateMachineClassLevel < ActiveModel::TestCase
...
class TestStateMachineInstanceLevel < ActiveModel::TestCase
  def setup
...
class TestStateMachineInitialStates < ActiveModel::TestCase
  def setup
    @foo = StateMachineSubject.new
  end
...
class TestStateMachineEventFiringWithPersistence < ActiveModel::TestCase
  def setup
...
class TestStateMachineEventFiringWithoutPersistence < ActiveModel::TestCase
  test 'updates the current state' do
    subj = StateMachineSubject.new
...
class TestStateMachinePersistence < ActiveModel::TestCase
...
class TestStateMachineEventCallbacks < ActiveModel::TestCase
...
class TestStateMachineStateActions < ActiveModel::TestCase
...
class TestStateMachineInheritance < ActiveModel::TestCase
...
class TestStateMachineWithComplexTransitions < ActiveModel::TestCase
  def setup
    @subj = StateMachineSubject.new
  end
